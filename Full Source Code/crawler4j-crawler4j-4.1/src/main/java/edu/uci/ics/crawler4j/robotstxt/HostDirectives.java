...
public class HostDirectives {
  ...
  public boolean allows(String path) {
    ...
    //System.out.println("here shows:!disallows.containsPrefixOf(path) || allows.containsPrefixOf(path);");
    //System.out.println(!disallows.containsPrefixOf(path) || allows.containsPrefixOf(path));
